...
fn main() {
    let window = Window::new_centered("Title", (1280, 720)).unwrap();

    let win: MyWindowHandler = MyWindowHandler {
        p: Pendulum::new(640.0, 0.0, 200.0),
        p2: Pendulum::new(640.0, 0.0, 400.0),
        p3: Pendulum::new(640.0, 0.0, 700.0),
    };
...
struct Pendulum {
    origin: Vector,   // pendulum position
